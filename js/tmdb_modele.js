let api_key = "2b5d9c50bb437e6b549dae5e834f3778";
let api_language = "fr";
...
let url_image_extra_small = "https://image.tmdb.org/t/p/w200";
let url_image_small = "https://image.tmdb.org/t/p/w300";
let url_image_original = "https://image.tmdb.org/t/p/original";

let r_last_movie = "https://api.themoviedb.org/3/movie/upcoming?api_key="+api_key+"&language="+api_language;						// Dernières sorties
let r_listing_movie = "https://api.themoviedb.org/3/discover/movie?api_key="+api_key+"&language="+api_language+"&sort_by={sort}";	// Listing filtré
let r_video_movie = "https://api.themoviedb.org/3/movie/{movie_id}/videos?api_key="+api_key+"&language="+api_language;				// Vidéos d'un
// film
let r_genre_movie = "https://api.themoviedb.org/3/genre/movie/list?api_key="+api_key+"&language="+api_language;						// La liste
// des genres
let r_detail_movie = "https://api.themoviedb.org/3/movie/{movie_id}?api_key="+api_key+"&language="+api_language;					// Détails d'un film
let r_detail_person = "https://api.themoviedb.org/3/person/{person_id}?api_key="+api_key+"&language="+api_language;					// Détails
// d'une personne

let r_search_movie = "https://api.themoviedb.org/3/search/movie?api_key="+api_key+"&language="+api_language;						// Recherche d'un
// film avec mot-clé
let r_search_people = "https://api.themoviedb.org/3/search/person?api_key="+api_key+"&language="+api_language;						// Recherche
// d'une personne avec mot-clé
...
function getSearchMovie(query, page = 1) {
	console.log('on est dans la fonction getSearchMovie')
	let arrSearchMovie = [];
	...
	return arrSearchMovie;
}

function getSearchPerson(query, page = 1) {
    console.log('on est dans la fonction getSearchPerson')
	let arrSearchPeople = [];
